...
person_tuple_list_test_() ->
	People = [{john, male, 1.8}, {jane, female, 2.6}, {martin, male, 1.0}, {sasha, female, 2.1}, {tim, male, 3.4}, {georgie, female, 1.2}, {elias, male, 0.6}, {daisy, female, 0.4}], % TODO: Replace this with the list of tuples described in the previous comment
